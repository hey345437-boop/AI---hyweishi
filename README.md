...
[中文文档](#功能特�? | [English](README.en.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [快速开始](#快速开�? | [AI 模型](#支持�?ai-模型)
...
### (￣▽�? AI 智能决策
- **12+ AI 服务�?* - DeepSeek、通义千问、GPT-5、Claude 4.5、Gemini 3 等最新模�?
- **AI 竞技�?* - 多个 AI 模型同时分析，投票决策，提高准确�?
- **5 种交易人�?* - 猎人�?均衡�?僧侣�?闪电�?冲浪型，适应不同风格
- **自定义提示词** - 完全自定�?AI 人设和交易策略，打造专属交易员
- **智能新闻分析** - AI 自动解读市场新闻，生成交易信�?

### (◎_�? 技术分�?
- **多时间周�?* - 支持 1m/5m/15m/1h/4h/1d 等多周期分析
- **丰富指标** - MA/EMA/RSI/MACD/KDJ/BOLL/ATR/OBV/VWAP �?
- **变化量追�?* - 指标变化趋势可视化，AI 更好理解市场动�?
- **双通道信号** - 多时间周期信号确认机�?

### (￥ω￥) 交易功能
- **OKX 合约交易** - 深度集成 OKX 永续合约 API
- **模拟交易** - Paper Trading 模式，零风险测试策略
- **风控系统** - 止损止盈、仓位管理、每日亏损限�?
- **多策略支�?* - 内置策略 + 自定义策略开�?
- **更多交易所** - 后续将支�?Binance、Bybit 等主流交易所
...
### 合约类型
- **USDT 永续合约** - �?USDT 结算的永续合�?
- **双向持仓模式** - 支持同时持有多空仓位

### 持仓模式
| 模式 | 说明 | 适用场景 |
|------|------|----------|
| 全仓 (Cross) | 所有仓位共享保证金，风险共�?| 资金利用率高，适合有经验的交易�?|
...
- **实时监控** - 持仓、收益、信号实时更�?
- **一键部�?* - Docker 支持，Windows/Linux/macOS 全平�?
...
install.bat
```
安装完成后双�?`启动机器�?bat` 启动，在 Web 界面中配�?API 密钥即可使用�?
...
```
启动后访�?http://localhost:8501，在界面中配�?API 密钥�?
...
docker-compose up -d
```
访问 http://localhost:8501，在界面中配�?API 密钥�?
...
> (・ω・) 也支持通过 `.env` 文件配置，适合高级用户�?Docker 部署
...
| 服务�?| 模型版本 | 免费额度 | 备注 |
|--------|---------|---------|------|
| DeepSeek | V3.1 Chat, R1 Reasoner | �?| 国产高性能，推�?|
| 通义千问 | Qwen 3 (235B), QwQ Plus | �?| 阿里云，深度思�?|
| 讯飞星火 | Spark 4.0 Ultra | �?Lite | 科大讯飞 |
| 腾讯混元 | Turbo Latest | �?Lite | 256K 上下�?|
| 火山豆包 | Doubao 1.5 Pro/Seed 1.6 | �?| 字节跳动 |
| 智谱 GLM | GLM-4.6, GLM-4 Plus | �?Flash | 国产领先 |
| OpenAI | GPT-5.2, o3, o4-mini | �?| 最新旗�?|
...
本项目采�?[AGPL-3.0](LICENSE) 开源许可证�?

**这意味着�?*
- �?可以免费使用、修改、分发本项目
- �?可以用于个人学习和研�?
- ⚠️ 修改后的代码必须同样开�?
- ⚠️ 如果将本项目用于网络服务，必须公开源代�?
- �?不得移除版权声明和许可证信息
