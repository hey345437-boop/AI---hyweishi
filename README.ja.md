...
- **マルチ戦略** - 内蔵戦略 + カスタム戦略開発
- **指値注文** - 価格オフセットとタイムアウト設定付きの指値注文をサポート
...
- **取引パラメーター** - インターフェースで取引ペア、レバレッジ、ポジションサイズを設定
...
| プロバイダー | モデル | 無料枠 | 備考 |
|--------------|--------|--------|------|
| DeepSeek | V3.1 Chat, R1 Reasoner | 有 | 高性能、推奨 |
| Qwen | Qwen 3 (235B), QwQ Plus | 有 | Alibaba Cloud、深い推論 |
| Spark | Spark 4.0 Ultra | 有 Lite | iFlytek |
| Hunyuan | Turbo Latest | 有 Lite | Tencent、256Kコンテキスト |
| Doubao | 1.5 Pro, Seed 1.6 | 有 | ByteDance |
| GLM | GLM-4.6, GLM-4 Plus | 有 Flash | Zhipu AI |
| OpenAI | GPT-5.2, o3, o4-mini | 無 | 最新フラッグシップ |
| Claude | Claude 4.5 Sonnet/Opus | 無 | Anthropic |
| Gemini | Gemini 3 Pro, 2.5 Flash | 有 | Google |
| Grok | Grok 4, Grok 3 | 有 | xAI |
| Perplexity | Sonar Pro, Reasoning | 有 | Web検索機能 |
