...
- **지정가 주문** - 가격 오프셋 및 타임아웃 설정이 있는 지정가 주문 지원
...
| 제공업체 | 모델 | 무료 티어 | 비고 |
|----------|------|-----------|------|
| DeepSeek | V3.1 Chat, R1 Reasoner | 유 | 고성능, 추천 |
| Qwen | Qwen 3 (235B), QwQ Plus | 유 | Alibaba Cloud, 깊은 추론 |
| Spark | Spark 4.0 Ultra | 유 Lite | iFlytek |
| Hunyuan | Turbo Latest | 유 Lite | Tencent, 256K 컨텍스트 |
| Doubao | 1.5 Pro, Seed 1.6 | 유 | ByteDance |
| GLM | GLM-4.6, GLM-4 Plus | 유 Flash | Zhipu AI |
| OpenAI | GPT-5.2, o3, o4-mini | 무 | 최신 플래그십 |
| Claude | Claude 4.5 Sonnet/Opus | 무 | Anthropic |
| Gemini | Gemini 3 Pro, 2.5 Flash | 유 | Google |
| Grok | Grok 4, Grok 3 | 유 | xAI |
| Perplexity | Sonar Pro, Reasoning | 유 | 웹 검색 기능 |
